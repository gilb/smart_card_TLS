...
the first commit corresponds to the initial code of Pascal Urien, not updated since 2005
the second commit is my modified code from 2011, with the following implementations:
